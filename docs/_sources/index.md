...
:maxdepth: 1
:caption: Notebooks 📖
notebooks/SE/summary_cds_bond_basis_ipynb.ipynb
```
...
dataframes/SE/ftsfr_cds_bond_basis_aggregated.md
dataframes/SE/ftsfr_cds_bond_basis_non_aggregated.md
```
...
replication of paper "Segmented Arbitrage" by Emil Siriwardane, Adi Sunderam, and Jonathan Wallen.
